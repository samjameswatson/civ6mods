...
VALUES	('LOC_BUILDING_AMPHITHEATER_NAME_UC_JNR',					'Theater'),
		...
		('LOC_POLICY_GRAND_OPERA_DESCRIPTION_JNR_UC',				'Extra [ICON_CULTURE] Culture from buildings in Theater Squares: +1 if city [ICON_CITIZEN] population is 15 or higher, +1 if district has at least +4 adjacency bonus.'),
