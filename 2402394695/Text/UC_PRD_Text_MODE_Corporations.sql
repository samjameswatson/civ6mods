...
VALUES	('LOC_BUILDING_KEIRETSU_NAME_UC_JNR',						'Keiretsu'),
		...
		('LOC_PROJECT_CREATE_PRODUCT_JNR_PHARMA_DESCRIPTION',		'Create a new product for the world based on the [ICON_RESOURCE_JNR__PHARMA] Pharmaceuticals resource.[NEWLINE]WARNING: Product will be lost permanently on creation if no free slot is available in any of your cities.{LOC_PRODUCT_JNR_PHARMA_BONUS_DESCRIPTION}'),
