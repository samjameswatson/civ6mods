...
VALUES	('LOC_BUILDING_JNR_TARGET_RANGE_NAME',							'Target Range'),
		...
		('LOC_BUILDING_JNR_CAVALIER_NAME',								'Cavalier'),
		...
		('LOC_BUILDING_SEAPORT_DESCRIPTION_UC_JNR',						'+2 [ICON_GOLD] Gold on all Coast tiles for this city.'),
		('LOC_BUILDING_HANGAR_DESCRIPTION_UC_JNR',						'+50% [ICON_Production] Production towards all air units trained in this city.[NEWLINE]+1 air unit slot in Aerodrome district.'),
		('LOC_BUILDING_AIRPORT_NAME_UC_JNR',							'Air Force Base'),
		('LOC_BUILDING_AIRPORT_DESCRIPTION_UC_JNR',						'+50% combat experience for air units trained in this city.[NEWLINE]Air units trained in this city start with a free promotion.[NEWLINE]+2 air unit slots in Aerodrome district.[NEWLINE]Allows the ability to airlift land units between Aerodrome districts with Air Force Bases after the Rapid Deployment civic is unlocked.'),
		('LOC_ABILITY_JNR_TARGET_RANGE_TRAINED_UNIT_XP_DESCRIPTION',	'+25% Earned experience from Target Range'),
		('LOC_ABILITY_JNR_CAVALIER_TRAINED_UNIT_XP_DESCRIPTION',		'+25% Earned experience from Cavalier'),
		...
		('LOC_POLICY_MILITARY_RESEARCH_DESCRIPTION_JNR_UC',				'Military Academies, Seaports, Hangars, and Renaissance Walls generate +2 [ICON_Science] Science.'),
		('LOC_POLICY_INTEGRATED_SPACE_CELL_DESCRIPTION_JNR_UC',			'+15% [ICON_Production] Production toward Space Race projects if a city has either a Military Academy, a Naval Base, or a Hangar.'),
		...
		('LOC_POLICY_THIRD_ALTERNATIVE_DESCRIPTION_JNR_UC',				'+100% Encampment district adjacency bonuses. +2 [ICON_Culture] Culture and +4 [ICON_Gold] Gold from each Research Lab, Military Academy, Arsenal, and Prison.'),
		...
		('LOC_BOOST_TRIGGER_GUNPOWDER_JNR_UC',							'Build an Armory or Cavalier.'),
...
VALUES	('LOC_MINOR_CIV_MILITARISTIC_TRAIT_MEDIUM_INFLUENCE_BONUS',		'2 [ICON_Production] Production in every city with a Barracks, Stable, or Target Range building when producing units.'),
		('LOC_MINOR_CIV_MILITARISTIC_TRAIT_LARGE_INFLUENCE_BONUS',		'+2 [ICON_Production] Production in every city with an Armory, Cavalier, or Supply Depot building when producing units.'),	
		('LOC_MINOR_CIV_MILITARISTIC_UNIQUE_INFLUENCE_BONUS_JNR',		'+2 [ICON_PRODUCTION] Production towards units in every city with a Military Academy, Arsenal, or Prison.');
--------------------------------------------------------------