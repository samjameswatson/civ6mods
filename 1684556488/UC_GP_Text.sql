...
INSERT OR REPLACE INTO BaseGameText
		(Tag,												Text)
VALUES	('LOC_BUILDING_GOV_JNR_MOCC_NAME',					'Military Operations Command Center'),
		('LOC_BUILDING_GOV_JNR_MOCC_DESCRIPTION',			'+1 Military policy slot[NEWLINE][NEWLINE]+3 [ICON_Movement] Movement and +2 [ICON_Range] Range for all aircraft units.[NEWLINE]+5 HP healing for all units.[NEWLINE][NEWLINE]Awards +1 [Icon_Governor] Governor Title.'),
		('LOC_BUILDING_GOV_JNR_PROPAGANDA_NAME',			'Institute of Truth'),
		('LOC_BUILDING_GOV_JNR_PROPAGANDA_DESCRIPTION',		'+1 Economic policy slot[NEWLINE][NEWLINE]All Rock Bands from the owner may enter foreign lands without Open Borders.[NEWLINE]All Rock Bands you create gain the Religious Rock ability in addition to a second ability you chose normally.[NEWLINE]All religious units ignore are camouflaged and ignore zone of control.[NEWLINE]Provides +5 Loyalty per turn to all your cities.[NEWLINE][NEWLINE]Awards +1 [Icon_Governor] Governor Title.'),
		...
		('LOC_BUILDING_GOV_JNR_DIPLOMACY_US_NAME',			'World Congress Headquarter'),
