...
VALUES	('LOC_DISTRICT_JNR_UC_OASIS_GOLD',								'+{1_num} [ICON_Gold] Gold from the adjacent Oasis {1_Num : plural 1?tile; other?tiles;}.'),
		...
		('LOC_POLICY_JNR_ADMIRALITY_COURT_DESCRIPTION',					'Extra [ICON_Gold] Yields from buildings in Commercial Hubs: +1 [ICON_PRODUCTION] if city [ICON_CITIZEN] population is 10 or higher, +1 [ICON_FOOD] Food if district has at least +6 adjacency bonus.'),
		('LOC_POLICY_FREE_MARKET_DESCRIPTION_JNR_UC',					'Extra [ICON_Gold] Gold from buildings in Commercial Hubs: +2 if city [ICON_CITIZEN] population is 10 or higher, +2 if district has at least +6 adjacency bonus.');
--------------------------------------------------------------
