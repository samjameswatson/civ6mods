...
INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MINT_GOLD_JNR_UC',					'BuildingType',	'BUILDING_JNR_WAYSTATION'			FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
...
INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_BANK_GOLD_UC_JNR',					'BuildingType',	'BUILDING_JNR_GUILDHALL'			FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';

INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_GUILDHALL_GOLD_UC_JNR',			'BuildingType',	'BUILDING_JNR_MERCHANT_QUARTER'		FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';

INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MERCHANT_QUARTER_GOLD_UC_JNR',		'BuildingType',	'BUILDING_BANK'						FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
...
INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MINT_GOLD_JNR_UC',					'YieldType',	'YIELD_GOLD'						FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
...
INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MARKET_GOLD_UC_JNR',				'Amount',		1									FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';

INSERT OR IGNORE INTO ModifierArguments
		(ModifierId,										Name,			Value)
SELECT	'JFD_FREE_MARKET_MINT_GOLD_JNR_UC',					'Amount',		2									FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
...
INSERT OR IGNORE INTO PolicyModifiers
		(PolicyType,	ModifierId)
SELECT	PolicyType,		'JFD_FREE_MARKET_MINT_GOLD_JNR_UC'					FROM Policies WHERE PolicyType='POLICY_JFD_FREE_MARKET';
