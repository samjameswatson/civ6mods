...
VALUES	('LOC_DISTRICT_AQUEDUCT_NAME_JNR_UC',					'Cistern'),
		...
		('LOC_ABILITY_JNR_HARDENED_STEEL_NAME',					'Hardened Steel'),
		('LOC_ABILITY_JNR_HARDENED_STEEL_DESCRIPTION',			'+2 [ICON_Strength] Combat Strength.'),
		('LOC_ABILITY_JNR_HARDENED_STEEL_MODIFIER_DESCRIPTION',	'+2 [ICON_Strength] Combat Strength from Hardened Steel.'),
		('LOC_POLICY_JNR_RESERVOIRS_NAME',						'Reservoirs'),
		('LOC_POLICY_JNR_RESERVOIRS_DESCRIPTION',				'+1 [ICON_Food] Food to all Farms adjacent to a Cistern, Dam, or Canal.');
