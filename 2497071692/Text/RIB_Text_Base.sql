...
VALUES	('LOC_JNR_RIB_BANANAS_RESOURCE_SET',							'[ICON_RESOURCE_BANANAS] Bananas'),
		...
		('LOC_JNR_CLOTHIER_LATE_GAME_BONUS',							'+1 [ICON_Gold] Gold to Pastures in cities with a Clothier.'),
		('LOC_JNR_BREWERY_LATE_GAME_BONUS',								'+1 [ICON_Gold] Gold to Farms over Resources in cities with a Brewery.'),
