...
UPDATE LocalizedText
SET Text = REPLACE(Text, 'Water Parks', 'Pleasure Piers')
WHERE Tag = Tag;

UPDATE LocalizedText
SET Text = REPLACE(Text, 'Water Park', 'Pleasure Pier')
WHERE Tag = Tag;
...
BEGIN
	UPDATE LocalizedText
	SET Text = REPLACE(NEW.Text, 'Water Parks', 'Pleasure Piers')
	WHERE Tag = NEW.Tag;

	UPDATE LocalizedText
	SET Text = REPLACE(NEW.Text, 'Water Park', 'Pleasure Pier')
	WHERE Tag = NEW.Tag;
END;
--------------------------------------------------------------